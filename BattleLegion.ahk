...
FoundX = 0
FoundX2 = 0
ImageSearch, FoundX, FoundY, startx,starty, startx + wwidth, starty + wheight, img/win.jpg
ImageSearch, FoundX2, FoundY2, startx,starty, startx + wwidth, starty + wheight, img/lose.jpg
if (FoundX > 0 || FoundX2 > 0){
	Wait()
